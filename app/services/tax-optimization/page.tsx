    ...
    <div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-gray-600 mb-8 font-sans leading-relaxed">
                Maximize your after-tax returns through strategic tax planning
                and optimization techniques. Our comprehensive approach helps
                you keep more of what you earn while staying compliant.
              </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto font-sans">
              Our multi-faceted approach to tax optimization covers all aspects
              of your financial life to minimize tax liability and maximize
              wealth accumulation.
            </p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <Card className="border-0 shadow-lg hover:shadow-xl transition-shadow">
              ...
              <CardContent>
                <p className="text-gray-600 font-sans text-center mb-4">
                  Strategic timing of asset sales to optimize capital gains tax
            ...
            <Card className="border-0 shadow-lg hover:shadow-xl transition-shadow">
              ...
              <CardContent>
                <p className="text-gray-600 font-sans text-center mb-4">
                  Optimize retirement account contributions and withdrawals to
            ...
            <Card className="border-0 shadow-lg hover:shadow-xl transition-shadow">
              ...
              <CardContent>
                <p className="text-gray-600 font-sans text-center mb-4">
                  Comprehensive income tax planning to reduce current and future
                  tax obligations.
                </p>
                <ul className="space-y-2 font-sans text-gray-600 text-sm">
                  <li className="flex items-center">
            ...
            <Card className="border-0 shadow-lg hover:shadow-xl transition-shadow">
              ...
              <CardContent>
                <p className="text-gray-600 font-sans text-center mb-4">
                  Minimize estate and gift taxes while maximizing wealth
            ...
            <Card className="border-0 shadow-lg hover:shadow-xl transition-shadow">
              ...
              <CardContent>
                <p className="text-gray-600 font-sans text-center mb-4">
                  Strategic tax planning for business owners and entrepreneurs
                  to minimize corporate tax burden.
                </p>
                <ul className="space-y-2 font-sans text-gray-600 text-sm">
                  <li className="flex items-center">
                    <CheckCircle className="h-4 w-4 text-amber-500 mr-2" />
            ...
            <Card className="border-0 shadow-lg hover:shadow-xl transition-shadow">
              ...
              <CardContent>
                <p className="text-gray-600 font-sans text-center mb-4">
                  Investment strategies designed to minimize tax drag and
                  maximize after-tax portfolio growth.
                </p>
                <ul className="space-y-2 font-sans text-gray-600 text-sm">
                  <li className="flex items-center">
                    <CheckCircle className="h-4 w-4 text-cyan-600 mr-2" />
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-serif font-black text-gray-900 mb-4">
              Our Tax Optimization Process
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto font-sans">
              A systematic approach to identifying tax-saving opportunities and
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div className="text-center">
              ...
              <p className="text-gray-600 font-sans">
                Comprehensive review of your current tax situation, including
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600 font-sans">
                Identify specific tax-saving opportunities based on your unique
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600 font-sans">
                Execute tax optimization strategies with proper documentation
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600 font-sans">
                Regular review and adjustment of tax strategies as laws change
      ...
      <section className="py-20 bg-gradient-to-r from-amber-500 to-amber-600">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-amber-100 mb-8 font-sans">
            Get a comprehensive tax review and personalized optimization
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link href="/contact">
              <Button
                size="lg"
                className="bg-white text-amber-500 hover:bg-gray-100 px-8 py-4 text-lg"
              >
                Get Tax Review
                <ArrowRight className="ml-2 h-5 w-5" />
              </Button>
