          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-gray-600 mb-8 font-sans leading-relaxed">
                Comprehensive risk analysis and management strategies to protect
                your investments and optimize returns while maintaining your
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto font-sans">
              We evaluate multiple risk dimensions to create a complete picture
              of your investment risk profile and develop appropriate mitigation
              strategies.
            </p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <Card className="border-0 shadow-lg hover:shadow-xl transition-shadow">
              ...
              <CardContent>
                <p className="text-gray-600 font-sans text-center mb-4">
                  Evaluate exposure to market volatility and systematic risks
            ...
            <Card className="border-0 shadow-lg hover:shadow-xl transition-shadow">
              ...
              <CardContent>
                <p className="text-gray-600 font-sans text-center mb-4">
                  Assess counterparty risk and credit quality of fixed income
                  investments and issuers.
                </p>
                <ul className="space-y-2 font-sans text-gray-600 text-sm">
                  <li className="flex items-center">
            ...
            <Card className="border-0 shadow-lg hover:shadow-xl transition-shadow">
              ...
              <CardContent>
                <p className="text-gray-600 font-sans text-center mb-4">
                  Evaluate the ability to convert investments to cash without
            ...
            <Card className="border-0 shadow-lg hover:shadow-xl transition-shadow">
              ...
              <CardContent>
                <p className="text-gray-600 font-sans text-center mb-4">
                  Identify and manage risks from over-concentration in specific
                  assets, sectors, or regions.
                </p>
                <ul className="space-y-2 font-sans text-gray-600 text-sm">
                  <li className="flex items-center">
                    <CheckCircle className="h-4 w-4 text-amber-500 mr-2" />
            ...
            <Card className="border-0 shadow-lg hover:shadow-xl transition-shadow">
              ...
              <CardContent>
                <p className="text-gray-600 font-sans text-center mb-4">
                  Measure potential losses during adverse market conditions and
                  recovery timeframes.
                </p>
                <ul className="space-y-2 font-sans text-gray-600 text-sm">
                  <li className="flex items-center">
            ...
            <Card className="border-0 shadow-lg hover:shadow-xl transition-shadow">
              ...
              <CardContent>
                <p className="text-gray-600 font-sans text-center mb-4">
                  Evaluate risks from operational failures, system issues, and
                  process breakdowns.
                </p>
                <ul className="space-y-2 font-sans text-gray-600 text-sm">
                  <li className="flex items-center">
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto font-sans">
              A systematic approach to identifying, measuring, and managing
              investment risks.
            </p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div className="text-center">
              ...
              <p className="text-gray-600 font-sans">
                Comprehensive identification of all potential risks affecting
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600 font-sans">
                Quantitative analysis using advanced metrics and models to
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600 font-sans">
                Implementation of strategies to reduce, transfer, or eliminate
                identified risks.
              </p>
            </div>
            <div className="text-center">
              ...
              <p className="text-gray-600 font-sans">
                Continuous monitoring and periodic review to ensure risk levels
                remain appropriate.
              </p>
            </div>
          </div>
      ...
      <section className="py-20 bg-gradient-to-r from-cyan-600 to-cyan-700">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-cyan-100 mb-8 font-sans">
            Get a comprehensive risk assessment and personalized risk management
            strategy today.
          </p>
