          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-gray-600 mb-8 font-sans leading-relaxed">
                Professional investment management that adapts to your goals,
                risk tolerance, and market conditions. Let our experienced team
                handle the complexities while you focus on what matters most.
              </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-serif font-black text-gray-900 mb-4">
              Why Choose Our Portfolio Management?
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto font-sans">
              Comprehensive investment management designed to maximize returns
              while managing risk.
            </p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <Card className="border-0 shadow-lg text-center hover:shadow-xl transition-shadow">
              <CardContent className="pt-8 pb-8">
                ...
                <p className="text-gray-600 font-sans text-sm">
                  Average annual returns of 15.2% over the past decade
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="border-0 shadow-lg text-center hover:shadow-xl transition-shadow">
              <CardContent className="pt-8 pb-8">
                ...
                <p className="text-gray-600 font-sans text-sm">
                  Advanced risk controls and diversification strategies
                </p>
              </CardContent>
            </Card>
              ...
              <div className="space-y-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 font-sans">
                      Every investment decision is backed by comprehensive
                      fundamental and technical analysis conducted by our
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 font-sans">
                      We continuously adjust portfolio allocations based on
                      market conditions, economic indicators, and your changing
                      life circumstances.
                    </p>
                  </div>
                </div>
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 font-sans">
                      Our focus is on generating superior risk-adjusted returns
                      rather than chasing short-term performance at the expense
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 font-sans">
                      Regular, detailed reports keep you informed about your
                      portfolio performance, holdings, and our investment
                      rationale.
                    </p>
                  </div>
                </div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto font-sans">
              Comprehensive portfolio management services designed to meet all
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto font-sans">
              Choose the plan that best fits your investment needs and portfolio
              size.
            </p>
          </div>
      ...
      <section className="py-20 bg-cyan-600">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-cyan-100 mb-8 font-sans">
            ...
            how our portfolio management can help you achieve them.
          </p>
          <Link href="/contact">
            <Button
              size="lg"
