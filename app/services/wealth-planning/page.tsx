          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-gray-600 mb-8 font-sans leading-relaxed">
                Strategic financial planning that goes beyond investments. We
                help you build, preserve, and transfer wealth across generations
                with comprehensive planning strategies.
              </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto font-sans">
              Our holistic approach covers all aspects of your financial life to
              ensure long-term wealth creation and preservation.
            </p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <Card className="border-0 shadow-lg hover:shadow-xl transition-shadow">
              ...
              <CardContent>
                <p className="text-gray-600 font-sans text-center mb-4">
                  Define and prioritize your financial goals with clear
                  timelines and actionable strategies.
                </p>
            ...
            <Card className="border-0 shadow-lg hover:shadow-xl transition-shadow">
              ...
              <CardContent>
                <p className="text-gray-600 font-sans text-center mb-4">
                  Protect your wealth and family with comprehensive insurance
            ...
            <Card className="border-0 shadow-lg hover:shadow-xl transition-shadow">
              ...
              <CardContent>
                <p className="text-gray-600 font-sans text-center mb-4">
                  Ensure smooth wealth transfer to future generations with
                  proper estate planning structures.
                </p>
                <ul className="space-y-2 font-sans text-gray-600 text-sm">
                  <li className="flex items-center">
                    <CheckCircle className="h-4 w-4 text-amber-500 mr-2" />
            ...
            <Card className="border-0 shadow-lg hover:shadow-xl transition-shadow">
              ...
              <CardContent>
                <p className="text-gray-600 font-sans text-center mb-4">
                  Build a secure retirement with strategic planning and
            ...
            <Card className="border-0 shadow-lg hover:shadow-xl transition-shadow">
              ...
              <CardContent>
                <p className="text-gray-600 font-sans text-center mb-4">
                  Minimize tax liability and maximize after-tax wealth through
            ...
            <Card className="border-0 shadow-lg hover:shadow-xl transition-shadow">
              ...
              <CardContent>
                <p className="text-gray-600 font-sans text-center mb-4">
                  Optimize your cash flow and liquidity management for better
                  financial stability.
                </p>
                <ul className="space-y-2 font-sans text-gray-600 text-sm">
                  <li className="flex items-center">
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto font-sans">
              A systematic approach to understanding your needs and creating a
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600 font-sans">
                Detailed analysis of gaps between current position and future
                goals with actionable recommendations.
              </p>
            </div>
            <div className="text-center">
              <div className="w-16 h-16 bg-amber-500 text-white rounded-full flex items-center justify-center mx-auto mb-4 text-2xl font-serif font-black">
              ...
              <p className="text-gray-600 font-sans">
                Development of customized wealth planning strategies aligned
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600 font-sans">
                Execution of the wealth plan with ongoing monitoring and
                periodic reviews for optimization.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-20 bg-gradient-to-r from-amber-500 to-amber-600">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-amber-100 mb-8 font-sans">
            Start your comprehensive wealth planning journey with our expert
            advisors today.
          </p>
