        ...
        <div className="max-w-2xl w-full space-y-8">
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-start space-x-2">
                    ...
                    <Label
                      ...
                      className="text-sm text-gray-600 font-sans leading-relaxed"
                    >
                      I would like to receive investment insights and market
                      updates via email
                    </Label>
                  </div>
                </div>
          ...
          <div className="text-center">
            <p className="text-xs text-gray-500 font-sans">
              Your personal information is encrypted and secure. We are SEBI
              registered and follow strict compliance standards.
            </p>
          </div>
        </div>
      </div>
