        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto font-sans">
              Ready to start your investment journey? Our team of experts is
            ...
            <Card className="border-0 shadow-lg text-center hover:shadow-xl transition-shadow">
              <CardContent className="pt-8 pb-8">
                ...
                <p className="text-gray-600 font-sans mb-4">
                  Speak directly with our investment advisors
                </p>
                <a
                  ...
                  <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div className="space-y-2">
                      ...
                      >
                        ...
                        <SelectContent>
                          ...
                          <SelectItem value="investment-planning">
                            Investment Planning
                          </SelectItem>
                    ...
                    <div className="space-y-2">
                      ...
                      >
                        ...
                        <SelectContent>
                          <SelectItem value="25-50-lakhs">
                            ₹25 - ₹50 Lakhs
                          </SelectItem>
                          <SelectItem value="50-lakhs-1-crore">
                            ₹50 Lakhs - ₹1 Crore
                          </SelectItem>
                          <SelectItem value="1-2-crores">
                            ₹1 - ₹2 Crores
                          </SelectItem>
                          <SelectItem value="2-5-crores">
                            ₹2 - ₹5 Crores
                          </SelectItem>
                          <SelectItem value="5-crores-plus">
                            ₹5 Crores+
                          </SelectItem>
                        </SelectContent>
                      </Select>
              ...
              <Card className="border-0 shadow-lg bg-cyan-50">
                <CardContent className="p-6">
                  ...
                  <div className="space-y-3 text-gray-700 font-sans">
                    <p>
                      <strong>Emergency Support:</strong> +91 98765 43200
                    ...
                    <p>
                      <strong>Client Portal Support:</strong>{" "}
